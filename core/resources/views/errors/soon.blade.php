 <!DOCTYPE html>
  ...
  <!-- BEGIN: Head-->
    ...
    <title>{{ $general->sitename.' Coming Soon'. }}</title>
    ...
    <div class="app-content content ">
      ...
      <div class="content-wrapper">
        ...
        <div class="content-body">
          <!-- Coming soon page-->
          <div class="misc-wrapper"><a class="brand-logo" href="page-misc-coming-soon.html#">
              ...
              <div class="w-100 text-center">
                ...
                <form class="row row-cols-md-auto row justify-content-center align-items-center m-0 mb-2 gx-3" action="javascript:void(0)">
                  ...
                  <div class="col-12 d-md-block d-grid ps-md-0 ps-auto">
                    <button class="btn btn--primary text-white mb-1 btn-sm-block" type="submit">Notify</button>
                  </div>
                </form><img class="img-fluid" src="{{ asset($activeTemplateTrue. 'app-assets/images/pages/coming-soon.svg')}}" alt="Coming soon page"/>
              </div>
            </div>
          </div>
          <!-- / Coming soon page-->
