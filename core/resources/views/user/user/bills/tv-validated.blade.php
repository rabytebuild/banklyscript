															...
															<table class="table">
																...
																<tbody>
																	<tr class="font-weight-bolder">
																		...
																		<td>{{$general->cur_sym}}{{env('CABLECHARGE')}}</td>
																		<td class="text-primary font-size-h3 font-weight-boldest text-right">{{$general->cur_sym}}{{number_format(env('CABLECHARGE') +$cost)}}</td>
																	</tr>
																</tbody>
															</table>
														</div>
