                                ...
                                <div class="buy-sell-widget">
                                    ...
                                    <div class="tab-content tab-content-default">
                                        <div class="tab-pane fade show active" id="buy" role="tabpanel">
                                            ...
                                            <form class="contact-form" action="{{route('user.resultwaec',$network['serviceID'])}}" class="currency_validate" action="" method="post" enctype="multipart/form-data">
                                            @csrf
							...
							<div class="col-xl-12">
								<div class="card">
									<div class="card-header">
										<div class="card-title">Recent Result Checker Purchase Log </div>
