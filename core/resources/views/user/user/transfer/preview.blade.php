        ...
        <div class="customer-card">
          <div class="card">
            ...
            <div class="card-body actions">
              ...
              <p class="card-text">@lang('Transfer Charge'): {{showAmount(0) }} {{__($general->cur_text)}}</p>
              <p class="card-text">@lang('Beneficiary Will Get'): {{showAmount($amount) }} {{__($general->cur_text)}}</p>
          ...
          <div class="card-body">
            <div class="row">
               <div class="col-md-12 col-sm-12">
                <div class="mb-2">
                <label class="form-label" cfor="checkout-name"><strong>Beneficiary Username</label>
             ...
             <div class="col-md-12 col-sm-12">
                <div class="mb-2">
                <label class="form-label" cfor="checkout-name"><strong>Beneficiary Full</label>
              ...
              <label class="form-check-label mb-50" for="customSwitch3">Save as beneficiary</label>
              <div class="form-check form-check-primary form-switch">
                <input type="checkbox" class="form-check-input" name="beneficiary" id="customSwitch3" />
              </div>
            </div>
            <br>
