...
<section class="invoice-preview-wrapper">
  <div class="row invoice-preview">
    ...
    <!-- Invoice Actions -->
    <div class="col-xl2 col-md-12 col-12 invoice-actions mt-md-0 mt-2">
      <div class="card">
        <div class="card-body">
          <button class="btn btn-outline-info text-white w-100 btn-download-invoice mb-75" data-bs-toggle="modal" data-bs-target="#transaction-sidebar">Statement</button>

          @if($status == "true")
          <a class="btn btn-warning w-100 mb-75" href="{{route('user.card.block',$card->reference)}}"> Block </a>
          @else
          <a class="btn btn-success w-100 mb-75" href="{{route('user.card.unblock',$card->reference)}}"> Unblock </a>
          @endif
  ...
  <div class="modal-dialog sidebar-lg">
    <div class="modal-content p-0">
      ...
      <div class="modal-body flex-grow-1">
        <form action="{{route('user.fundcard',$card->reference)}}" method="post">
@csrf
          <div class="mb-1">
            <input id="balance" class="form-control" type="text" value="Wallet Balance: {{$general->cur_sym}}{{Auth::user()->balance}}" disabled />
          </div>
          <div class="mb-1">
          ...
          <div class="mb-1">
           <p class="text-danger">Please note that the fund to service this virtual card will be deducted from your Deposit Wallet
          </div>
...
<div class="modal modal-slide-in fade" id="transaction-sidebar" aria-hidden="true">
  <div class="modal-dialog sidebar-lg">
    <div class="modal-content p-0">
      ...
      <div class="modal-body flex-grow-1">
        <form action="{{route('user.trxcard',$card->reference)}}" method="post">
@csrf
          <div class="mb-1">
