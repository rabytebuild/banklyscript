                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-9 col-9">
                        <div class="partner-box partner-carousel">
                            <div class="single">
                                <div class="item">
                                    <img src="{{url('/')}}/assets/frontend/assets/images/partner-1.png" alt="image">
                                </div>
                            </div>
                            <div class="single">
                                <div class="item">
                                    <img src="{{url('/')}}/assets/frontend/assets/images/partner-2.png" alt="image">
                                </div>
                            </div>
                            <div class="single">
                                <div class="item">
                                    <img src="{{url('/')}}/assets/frontend/assets/images/partner-3.png" alt="image">
                                </div>
                            </div>
                            <div class="single">
                                <div class="item">
                                    <img src="{{url('/')}}/assets/frontend/assets/images/partner-4.png" alt="image">
                                </div>
                            </div>
                            <div class="single">
                                <div class="item">
                                    <img src="{{url('/')}}/assets/frontend/assets/images/partner-5.png" alt="image">
                                </div>
                            </div>
                            <div class="single">
                                <div class="item">
            ...
            <div class="container wow fadeInUp">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="top-section">
                            <span class="head-icon d-flex justify-content-center align-items-center">
                                <img src="{{url('/')}}/assets/frontend/assets/images/icon/notification.png" alt="icon">
                            </span>
                            ...
                            <ul class="list">
                                <li class="list-item d-flex align-items-center">
                                    <span class="check d-flex align-items-center justify-content-center">
                                        <img src="{{url('/')}}/assets/frontend/assets/images/icon/check.png" alt="icon">
                                    </span>
                    ...
                    <div class="col-lg-6 text-end">
                        <div class="img-area">
                            <img src="{{url('/')}}/assets/frontend/assets/images/feature-item-1.png" alt="image">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container wow fadeInUp">
                <div class="row">
                    <div class="col-lg-6 text-start cus-ord">
                        <div class="img-area">
                            <img src="{{url('/')}}/assets/frontend/assets/images/feature-item-2.png" alt="image">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="top-section">
                            <span class="head-icon d-flex justify-content-center align-items-center">
                                <img src="{{url('/')}}/assets/frontend/assets/images/icon/sheled.png" alt="icon">
                            </span>
            ...
            <div class="container wow fadeInUp">
                ...
                <div class="row cus-mar">
                    <div class="col-lg-4 col-md-6">
                        <div class="single-box text-center">
                            <div class="thumb d-flex justify-content-center align-items-center">
                                <img src="{{url('/')}}/assets/frontend/assets/images/icon/checking.png" alt="checking">
                            </div>
                            <div class="content">
                                ...
                                <a href="register.html" class="btn-arrow">Open Account
                                    <img src="{{url('/')}}/assets/frontend/assets/images/icon/arrow-right.png" alt="arrow">
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="single-box text-center">
                            <div class="thumb d-flex justify-content-center align-items-center">
                                <img src="{{url('/')}}/assets/frontend/assets/images/icon/savings.png" alt="checking">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-box text-center">
                            <div class="thumb d-flex justify-content-center align-items-center">
                                <img src="{{url('/')}}/assets/frontend/assets/images/icon/business.png" alt="checking">
                            </div>
                            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="button-group d-flex align-items-center flex-wrap">
                            <a href="javascript:void(0)"><img src="{{url('/')}}/assets/frontend/assets/images/google-play.png" alt="image"></a>
                            <a href="javascript:void(0)"><img src="{{url('/')}}/assets/frontend/assets/images/app-store.png" alt="image"></a>
                        </div>
                    </div>
                    <div class="col-lg-6 text-end">
                        <div class="img-area">
                            <img class="max-un" src="{{url('/')}}/assets/frontend/assets/images/apps.png" alt="image">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row justify-content-end">
                    <div class="col-lg-6">
                        <div class="section-header">
                            <h5 class="sub-title">Boost your savings with the right credit card</h5>
                            <h2 class="title">Access Endless Possibilities with Bankio Card</h2>
                    ...
                    <div class="col-lg-5">
                        <div class="pb-120">
                            <div class="card-carousel-index">
                                <div class="single">
                                    <div class="thumb">
                                        <img src="{{url('/')}}/assets/frontend/assets/images/card-img-1.png" alt="image">
                                    </div>
                                ...
                                <div class="single">
                                    <div class="thumb">
                                        <img src="{{url('/')}}/assets/frontend/assets/images/card-img-2.png" alt="image">
                                    </div>
                                    <div class="button-area text-center">
                                        <a href="register.html" class="cmn-btn">Get Started Now</a>
                                    </div>
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="debit-tab" data-bs-toggle="tab" data-bs-target="#debit"
                                    type="button" role="tab" aria-controls="debit" aria-selected="false">Debit
                                    Card</button>
                            </li>
                        </ul>
                            ...
                            <div class="tab-pane fade show active" id="credit" role="tabpanel"
                                ...
                                <div class="row cus-mar">
                                    <div class="col-md-6">
                                        <div class="single-box text-center">
                                            <div class="thumb">
                                                <img src="{{url('/')}}/assets/frontend/assets/images/icon/tab-card-1.png" alt="icon" class="active">
                                                <img src="{{url('/')}}/assets/frontend/assets/images/icon/tab-card-11.png" alt="icon" class="alt">
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="single-box text-center">
                                            <div class="thumb">
                                                <img src="{{url('/')}}/assets/frontend/assets/images/icon/tab-card-2.png" alt="icon" class="active">
                                                <img src="{{url('/')}}/assets/frontend/assets/images/icon/tab-card-22.png" alt="icon" class="alt">
                                            </div>
                                            <a href="javascript:void(0)">
                                    ...
                                    <div class="col-md-6">
                                        <div class="single-box text-center">
                                            <div class="thumb">
                                                <img src="{{url('/')}}/assets/frontend/assets/images/icon/tab-card-3.png" alt="icon" class="active">
                                                <img src="{{url('/')}}/assets/frontend/assets/images/icon/tab-card-33.png" alt="icon" class="alt">
                                            </div>
                                            <a href="javascript:void(0)">
                                                <h5>Travel</h5>
                                            </a>
                                    ...
                                    <div class="col-md-6">
                                        <div class="single-box text-center">
                                            <div class="thumb">
                                                <img src="{{url('/')}}/assets/frontend/assets/images/icon/tab-card-4.png" alt="icon" class="active">
                                                <img src="{{url('/')}}/assets/frontend/assets/images/icon/tab-card-44.png" alt="icon" class="alt">
                                            </div>
                                            <a href="javascript:void(0)">
                                                <h5>Cashback</h5>
                                            </a>
            ...
            <div class="container wow fadeInUp">
                <div class="row d-flex justify-content-center">
                    <div class="col-xl-6 col-lg-5">
                        ...
                        <a href="register.html" class="cmn-btn">Apply for a loan</a>
                    </div>
                    <div class="col-xl-6 col-lg-7">
                        <div class="row cus-mar">
                            <div class="col-md-6 col-sm-6">
                                <div class="plan-box">
                                    <div class="thumb">
                                        <img src="{{url('/')}}/assets/frontend/assets/images/icon/loan-1.png" alt="icon" class="active">
                                        <img src="{{url('/')}}/assets/frontend/assets/images/icon/loan-11.png" alt="icon" class="alt">
                                    </div>
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="plan-box">
                                    <div class="thumb">
                                        <img src="{{url('/')}}/assets/frontend/assets/images/icon/loan-2.png" alt="icon" class="active">
                                        <img src="{{url('/')}}/assets/frontend/assets/images/icon/loan-22.png" alt="icon" class="alt">
                                    </div>
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="plan-box">
                                    <div class="thumb">
                                        <img src="{{url('/')}}/assets/frontend/assets/images/icon/loan-3.png" alt="icon" class="active">
                                        <img src="{{url('/')}}/assets/frontend/assets/images/icon/loan-33.png" alt="icon" class="alt">
                                    </div>
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="plan-box">
                                    <div class="thumb">
                                        <img src="{{url('/')}}/assets/frontend/assets/images/icon/loan-4.png" alt="icon" class="active">
                                        <img src="{{url('/')}}/assets/frontend/assets/images/icon/loan-44.png" alt="icon" class="alt">
                                    </div>
            ...
            <div class="container wow fadeInUp">
                <div class="row d-flex justify-content-between">
                    <div class="col-lg-6 col-xl-5 d-flex align-items-center justify-content-end">
                        <div class="img-area">
                            <img src="{{url('/')}}/assets/frontend/assets/images/personalized.png" alt="image">
                        </div>
                    </div>
                    ...
                    <div class="testimonials-carousel">
                        <div class="slide-item">
                            <div class="single-slide">
                                <div class="thumb">
                                    <img src="{{url('/')}}/assets/frontend/assets/images/testomonial.png" alt="image" class="max-un">
                                </div>
                                <div class="content">
                                    <div class="top-content">
                                        <img src="{{url('/')}}/assets/frontend/assets/images/icon/quote.png" alt="quote">
                                        <h5>“I love Bankio, they're the best”</h5>
                                        <p class="xxlr">
                                            “ It's been 2 years since I found Bankio, and it's such a relief as a small
                                            business
            ...
            <div class="container">
                <div class="col-12">
                    <div class="get-content">
                        ...
                        <a href="{{url('/')}}/register" class="cmn-btn">Open an Account</a>
