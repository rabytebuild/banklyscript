                    ...
                    <div class="card-body">
                        ...
                        <div class="row justify-content-between">
                            ...
                            <div class="col-md-5 mt-md-0 mt-3">
                                <button type="button" data-bs-toggle="modal" data-bs-target="#addModal" class="btn btn-sm  text-white btn--primary box--shadow1 text--small float-right"><i class="fa fa-plus"></i> @lang('Add New Key') </button>
                                 <button type="button" class="btn btn-sm  text-white btn--primary box--shadow1 importBtn"><i class="la la-download"></i>@lang('Import Language')</button>
