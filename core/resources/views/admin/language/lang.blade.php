        ...
        <div class="col-md-12 mb-30">
            ...
            <div class="card bl--5-primary">
                <div class="card-body">
                  ...
                  <a class="btn btn-sm btn--primary text-white box--shadow1 text-white text--small" data-bs-toggle="modal" data-bs-target="#createModal"><i class="fa fa-fw fa-plus"></i>@lang('Add New Language')</a>
            <hr>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td data-label="@lang('Default')">
                                        @if($item->is_default == 1)
                                            <span class="text--small badge font-weight-normal bg-success">@lang('Default')</span>
                                        @else
                                            <span class="text--small badge font-weight-normal bg-warning">@lang('Selectable')</span>
                                        @endif
                                    </td>
                                    <td data-label="@lang('Action')">
                                        <a href="{{route('admin.language.key', $item->id)}}" class="btn-sm btn btn-success" data-toggle="tooltip" data-original-title="@lang('Translate')">
                                            Configure
                                        </a>
                                        <a href="javascript:void(0)" class="btn-primary btn btn-sm ml-1 editBtn" data-original-title="@lang('Edit')" data-toggle="tooltip" data-url="{{ route('admin.language.manage.update', $item->id)}}" data-lang="{{ json_encode($item->only('name', 'text_align', 'is_default')) }}">
                                            Edit
                                        </a>
                                        @if($item->id != 1)
                                            <a href="javascript:void(0)" class="btn-sm btn btn-danger ml-1 deleteBtn" data-original-title="@lang('Delete')" data-toggle="tooltip" data-url="{{ route('admin.language.manage.del', $item->id) }}">
                                                Delete
                                            </a>
                                        @endif
    ...
    <div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="createModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <input type="checkbox" class="form-check-input"  name="is_default" id="customSwitch10" />
