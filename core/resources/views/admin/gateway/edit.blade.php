    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
              ...
              <img src="{{ getImage(imagePath()['gateway']['path'].'/'. $gateway->image,imagePath()['gateway']['size']) }}" alt="avatar" />
                                    ...
                                    <br>
                                        ...
                                        <div class="input-group mb-1 d-flex flex-wrap justify-content-end has_append width-375">
                                            <select class="form-control newCurrencyVal ">
                                            ...
                                            <div class="input-group-append">
                                                <button type="button" class="btn text-white btn--primary newCurrencyBtn" data-crypto="{{ $gateway->crypto }}" data-name="{{ $gateway->name }}">@lang('Add new')
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="payment-method-item child--item">
                                    <div class="payment-method-header">
                                        <div class="thumb">
                                            ...
                                            <div class="avatar-edit">
                                                <input type="file" name="currency[{{ $currencyIdx }}][image]" id="image{{ $currencyIdx }}" class="profilePicUpload form-control" accept=".png, .jpg, .jpeg"/>
                                                ...
                                                <div class="remove-btn">
                                                    <button type="button" class="btn  text-white btn-danger deleteBtn" data-id="{{ $gatewayCurrency->id }}" data-name="{{ $gatewayCurrency->currencyIdentifier() }}">
                                    ...
                                    <div class="payment-method-body">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                                                <div class="card border-primary mt-2">
                                                    <h5 class="card-header bg-primary text-white">@lang('Currency')</h5>
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="input-group mb-3">
                        ...
                        <div class="payment-method-item child--item newMethodCurrency d-none">
                            ...
                            <div class="payment-method-header">
                                <div class="thumb">
                                    ...
                                    <div class="avatar-edit">
                                        <input disabled type="file" accept=".png, .jpg, .jpeg" class="form-control profilePicUpload" id="image{{ $currencyIdx }}" name="currency[{{ $currencyIdx }}][image]"/>
                                        <label for="image{{ $currencyIdx }}" class="bg-primary"><i class="fa fa-pencil"></i></label>
                                    </div>
                                </div>
                                        <div class="form-group mb-1">
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('admin.gateway.automatic.remove', $gateway->code) }}" method="POST">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn  text-white  btn--danger">@lang('Delete')</button>
                    </div>
                </form>
            </div>
        </div>
