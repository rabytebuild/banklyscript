    ...
    <div class="row mb-none-30">
        ...
        <div class="col-md-12 mb-30">
            ...
            <div class="card">
              ...
              <img src="{{ getImage(imagePath()['logoIcon']['path'].'/logo.png', '?'.time()) }}" alt="avatar" />
                                        ...
                                        <div class="avatar-edit">
                                            <input type="file" class="form-control profilePicUpload" id="profilePicUpload1" accept=".png, .jpg, .jpeg" name="logo">
                                    ...
                                    <div class="thumb">
                                        <div class="avatar-preview">
                                            <div class="row">
                                                ...
                                                <div class="avatar avatar-xl">
              <img src="{{ getImage(imagePath()['logoIcon']['path'] .'/favicon.png', '?'.time()) }}" alt="avatar" />
                                        ...
                                        <div class="avatar-edit">
                                            <input type="file" class="form-control profilePicUpload" id="profilePicUpload2" accept=".png" name="favicon">
                        ...
                        <br>
                        <button type="submit" class="btn btn--primary text-white btn-block">@lang('Update')</button>
                    </form>
                </div>
            </div>
        </div>
