                        ...
                        <div class="row">
                            <div class="col-xl-4">
                                <div class="form-group">
                                   ...
                                   <img src="{{getImage(imagePath()['seo']['path'].'/'. @$seo->data_values->image,imagePath()['seo']['size']) }}" class="img-fluid" alt="img-placeholder" />
                                            ...
                                            <br>
                                                <input type="file" class="form-control profilePicUpload" name="image_input" id="profilePicUpload1" accept=".png, .jpg, .jpeg">
