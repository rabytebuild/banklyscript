                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.frontend.sections.content', $key)}}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="image-upload">
                                                        <div class="thumb">
                                                            <div class="avatar-preview">
                                                             <img src="{{getImage('assets/images/frontend/' . $key .'/'. @$content->data_values->$imgKey,@$section->content->images->$imgKey->size) }}" class="img-fluid" alt="img-placeholder" />
                            ...
                            <div class="form-group">
                                <button type="submit" class="text-white btn btn--primary btn-block">@lang('Submit')</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    @if(@$section->element)
        ...
        <div class="row">
            ...
            @if($section->element->modal)
                <a href="javascript:void(0)" class="btn btn-sm btn--primary text-white box--shadow1 text--small addBtn"><i class="fa fa-fw fa-plus"></i>@lang('Add New')</a>
            <hr>
            @else
                <a href="{{route('admin.frontend.sections.element',$key)}}" class="btn btn-sm btn--success text-white box--shadow1 text--small"><i class="fa fa-fw fa-plus"></i>@lang('Add New')</a>
            <hr>
            @endif
                                ...
                                @forelse($elements as $data)
                                    <tr>
                                            ...
                                            <td data-label="@lang('Image')">
                                                <div class="customer-details d-block">
                                                    <a href="javascript:void(0)" class="thumb">
                                                        <img src="{{ getImage('assets/images/frontend/' . $key .'/'. @$data->data_values->$firstKey,@$section->element->images->$firstKey->size) }}" width="50" alt="@lang('image')">
                                                    </a>
                                                </div>
                                            </td>
                                        @endif
                                        ...
                                        <td data-label="@lang('Action')">
                                            ...
                                            @endphp
                                                <button class="btn btn-sm text-white updateBtn"
                                                    data-id="{{$data->id}}"
