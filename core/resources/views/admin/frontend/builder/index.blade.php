                ...
                <form action="{{ route('admin.frontend.manage.pages.update')}}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>&nbsp;</label>
                                <button type="submit" class="btn btn--primary text-white btn-block btn-lg">@lang('Update')</button>
                            </div>
                        </div>
                    </div>
                </form>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('admin.frontend.manage.section.update',$pdata->id)}}" method="post">
                    ...
                    <button type="submit" class="btn  btn--primary text-white  btn-block btn-lg ">@lang('Update Now')</button>
                </form>
