                ...
                <div class="card-body p-0">
                    <div class="d-flex p-3 bg--primary align-items-center">
                        <div class="avatar avatar--lg">
                            <img src="{{ getImage(imagePath()['profile']['admin']['path'].'/'. $admin->image,imagePath()['profile']['admin']['size'])}}" width="100" alt="@lang('Image')">
                        </div>
                        <div class="pl-3">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.profile.update') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="image-upload">
                                        <div class="thumb">
                                            ...
                                            <div class="avatar-edit">
                                                <input type="file" class="form-control profilePicUpload" name="image" id="profilePicUpload1" accept=".png, .jpg, .jpeg">
                        ...
                        <div class="form-group mb-1">
                            <button type="submit" class="btn text-white btn--primary btn-block btn-lg">@lang('Save Changes')</button>
                        </div>
                    </form>
                </div>
            </div>
