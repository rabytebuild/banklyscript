                            ...
                            <div class="payment-method-header">
                                <div class="thumb">
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="w-100">@lang('Rate')1 {{ __($general->cur_text) }} = <span class="currency_symbol"></span> <span class="text-danger">*</span></label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card border-primary my-2">
                                            ...
                                            <h5 class="card-header  text-white bg-primary">@lang('Withdraw Instruction') </h5>
                                            <div class="card-body">
                                                <div class="form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card border-primary">
                                            <h5 class="card-header text-white bg-primary">@lang('User data')
