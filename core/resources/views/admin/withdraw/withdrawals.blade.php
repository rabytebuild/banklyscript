  ...
  <div class="row">
    <div class="col-lg-4 col-sm-6 col-12">
      <div class="card">
        <div class="card-header">
          <div>
            <h2 class="fw-bolder mb-0"> {{ __($general->cur_sym) }}{{ $withdrawals->where('status',1)->sum('amount') }}</h2>
            <p class="card-text">@lang('Approved Withdrawals')</p>
          </div>
    ...
    <div class="col-lg-4 col-sm-6 col-12">
      <div class="card">
        <div class="card-header">
          <div>
            <h2 class="fw-bolder mb-0">{{ __($general->cur_sym) }}{{ $withdrawals->where('status',2)->sum('amount') }}</h2>
            <p class="card-text">@lang('Pending Withdrawal')</p>
          </div>
    ...
    <div class="col-lg-4 col-sm-6 col-12">
      <div class="card">
        <div class="card-header">
          <div>
            <h2 class="fw-bolder mb-0">{{ __($general->cur_sym) }}{{ $withdrawals->where('status',3)->sum('amount') }}</h2>
            <p class="card-text">@lang('Rejected Withdrawals')</p>
          </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Action')">
                                    <a href="{{ route('admin.withdraw.details', $withdraw->id) }}" class="btn btn-primary btn-sm " data-toggle="tooltip" data-original-title="@lang('Detail')">
                                        View
                                    </a>
                                </td>
                            </tr>
