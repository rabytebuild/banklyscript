    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card">
              ...
              <img src="{{getImage(imagePath()['gateway']['path'].'/'. $method->image,imagePath()['gateway']['path'])}}" alt="avatar" />
                            ...
                            <div class="payment-method-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="card border-primary mt-3">
                                            <h5 class="card-header  text-white bg-primary">@lang('Charge')</h5>
                                            <div class="card-body">
                                                <div class="input-group mb-3">
                                        ...
                                        <div class="card border-primary mt-3">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <br>
                                                    ...
                                                    <option value="0" @if($method->crypto == 0) selected @endif>Fiat</option>
                                                    <option value="1" @if($method->crypto == 1) selected @endif>Cryptocurrency</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card border-primary mt-3">
                                            ...
                                            <h5 class="card-header  text-white bg-primary">@lang('Deposit Instruction')</h5>
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <textarea rows="4" class="form-control border-radius-5 nicEdit" name="instruction">{{ __(@$method->description)  }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
