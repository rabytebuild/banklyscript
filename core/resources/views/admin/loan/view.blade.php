        ...
        <!-- Sales Line Chart Card -->
          <div class="card">
            <div class="card-header align-items-start">
              ...
              @if($loan->status == 1)
              <button type="button" data-bs-toggle="modal" data-bs-target="#inlineForm" class="btn text-white btn--primary">
              <i data-feather="credit-card" class="me-25"></i>
              <span>Pay</span>
            </button>
            <button type="button" data-bs-toggle="modal" data-bs-target="#inlineFormclose" class="btn btn-success">
...
<div class="demo-spacing-0">
            <div class="alert alert-danger" role="alert">
              <div class="alert-body">User has not made any payment yet.</div>
            </div>
          </div>
          @endif
        </div>
                ...
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h4 class="modal-title" id="myModalLabel33">You are about to make payment for this running loan. Please enter an amount below to service the loan</h4>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form action="{{route('admin.loan.pay',$loan->reference)}}" method="post">
                    @csrf
 ...
 <!-- Modal -->
              ...
              >
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h4 class="modal-title" id="myModalLabel33">You are about to close this loan. This will terminate the loan plan and mark this loan as comepleted</h4>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form action="{{route('admin.loan.close',$loan->reference)}}" method="post">
                    @csrf
                      <div class="modal-body">
