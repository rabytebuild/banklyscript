...
class PaymentController extends Controller
{
    ...
    public function deposit()
    {
        ...
        return view($this->activeTemplate . 'user.deposit.deposit', compact('logs','emptyMessage','gatewayCurrency', 'pageTitle'));
    }
        ...
        if ($data->status == 0) {
            ...
            $adminNotification->save();
             ...
             if($general->deposit_commission == 1){
                $commissionType =  'Commission Rewarded For '. number_format($data->amount) . ' '.$general->cur_text.' Deposit';
